...
public class SideBar extends TextView {
    private String[] letters = new String[]{"業績", "除權息", "法說會", "增減資", "其他", "個人", };
    ...
    private void init(AttributeSet attrs) {
        ...
        bigTextPaint.setTextAlign(Paint.Align.RIGHT);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        Log.d("123456",Integer.toString(event.getAction()));
