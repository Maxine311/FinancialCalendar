...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void initPaint(Context context) {
        mCurMonthTextPaint.setAntiAlias(false);//true
        ...
        mCurMonthTextPaint.setTextSize(CalendarUtil.dipToPx(context, TEXT_SIZE));//被選中的日期

        mOtherMonthTextPaint.setAntiAlias(false);//true
        ...
        mCurMonthLunarTextPaint.setAntiAlias(false);//true
        mCurMonthLunarTextPaint.setTextAlign(Paint.Align.CENTER);

        mSelectedLunarTextPaint.setAntiAlias(false);//true
        mSelectedLunarTextPaint.setTextAlign(Paint.Align.CENTER);

        mOtherMonthLunarTextPaint.setAntiAlias(false);//true
        mOtherMonthLunarTextPaint.setTextAlign(Paint.Align.CENTER);


        mSchemeLunarTextPaint.setAntiAlias(false);//true
        mSchemeLunarTextPaint.setTextAlign(Paint.Align.CENTER);

        //有事件日期
        mSchemeTextPaint.setAntiAlias(false);//true
        mSchemeTextPaint.setStyle(Paint.Style.FILL);//選中日期外框
        mSchemeTextPaint.setTextAlign(Paint.Align.CENTER);//選中日期至中
        ...
        //選中日期
        mSelectTextPaint.setAntiAlias(false);//true
        ...
        mSchemePaint.setAntiAlias(false);//true
        mSchemePaint.setStyle(Paint.Style.FILL);
        mSchemePaint.setStrokeWidth(2);
        mSchemePaint.setColor(0xffefefef);

        mCurDayTextPaint.setAntiAlias(false);//true
        mCurDayTextPaint.setTextAlign(Paint.Align.LEFT);
        ...
        mCurDayLunarTextPaint.setAntiAlias(false);//true
        ...
        mSelectedPaint.setAntiAlias(false);//true
